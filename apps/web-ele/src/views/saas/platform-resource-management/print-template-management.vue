...
function handleFilterSubmit() {
  filterState.value = {
    templateName: filterState.value.templateName.trim(),
    templateType: filterState.value.templateType.trim(),
        ...
        >
          <div class="saas-filter-grid">
            <ElFormItem label="模板名称">
              <ElInput
                v-model="filterState.templateName"
                clearable
                placeholder="请输入模板名称"
              />
            </ElFormItem>
            ...
            <ElFormItem label="模板类型">
              <ElSelect
                v-model="filterState.templateType"
                clearable
                filterable
                placeholder="请选择模板类型"
              >
