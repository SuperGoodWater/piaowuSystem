...
function handleFilterSubmit() {
  filterState.value = {
    departmentName: filterState.value.departmentName.trim(),
    manager: filterState.value.manager.trim(),
        ...
        >
          <div class="saas-filter-grid">
            <ElFormItem label="部门名称">
              <ElInput
                v-model="filterState.departmentName"
                clearable
                placeholder="请输入部门名称"
              />
            </ElFormItem>
