...
function handleFilterSubmit() {
  filterState.value = {
    initiatorStore: filterState.value.initiatorStore.trim(),
    relatedStores: filterState.value.relatedStores.trim(),
      ...
      <div class="saas-filter-panel rounded-md bg-card p-3">
        ...
        >
          <div class="saas-filter-grid">
            <ElFormItem label="发起门店">
              <ElInput
                v-model="filterState.initiatorStore"
                clearable
                placeholder="请输入发起门店"
              />
            </ElFormItem>
            ...
            <ElFormItem label="关联门店">
              <ElInput
                v-model="filterState.relatedStores"
                clearable
                placeholder="请输入关联门店"
              />
            </ElFormItem>

            <ElFormItem label="联营状态">
              <ElSelect
              ...
              >
                <ElOption
                  v-for="option in jointOperationStatusOptions"
                  :key="option.value"
                  :label="option.label"
                  :value="option.value"
                />
